...
The package provides functions to quickly remove rows with missing values from a data frame and convert a character column to a numeric column and convert non-numeric values to NA. I chose this functionality because when I first started out with R and working with data frames I had some difficulties with both of these aspects and figuring it out ate up more of my time than necessary.
...
e.g. https://github.com/LevinM2101/dataCleanse
...
```
```{r}
remotes::install_github("LevinM2101/dataCleanse")
```
